...
- **Web Scraping:** Firecrawl API. The `Scraper Agent` makes HTTP requests to Firecrawl to bypass anti-bot protections and extract clean markdown from job portals.
